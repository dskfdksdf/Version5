...
<head>
    ...
    <script type="text/javascript" src="${basePath}/web/js/confactorywebpage.js"></script>
...
<div class="panel panel-default">
    ...
    <input type="hidden" id="br" name="br" value="${articleBean.brand}"/>  --%>
        ...
        <div class="panel-heading">
            ...
            <h3 class="panel-title">企业表信息查询</h3>
            <a href="../confactory/webadd">新增企业信息</a>
        </div>
        ...
        <div class="panel-body">
            <div class="title">
                ...
                <div class="announce-info">
                    <form action="<%=basePath%>/confactory/webpage" method="post">
                        <table class="table table-bordered">
                            <tbody>
                            <tr>
                                <td class="heading">企业名称</td>
                                <td>
