...
<head>
    ...
    <script type="text/javascript" src="${basePath}/web/js/elevatorwebpage.js"></script>
...
<div class="panel panel-default">
    ...
    <input type="hidden" id="br" name="br" value="${articleBean.brand}"/>  --%>
        ...
        <div class="panel-heading">
            ...
            <h3 class="panel-title">施工电梯(产权)信息查询</h3>
            <a href="../elevator/webadd">新增施工电梯(产权)信息</a>
        </div>
        ...
        <div class="panel-body">
            <div class="title">
                ...
                <div class="announce-info">
                    <form action="<%=basePath%>/elevator/webpage" method="post">
