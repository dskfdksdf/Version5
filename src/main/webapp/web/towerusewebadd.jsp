...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <form action="${basePath}/toweruse/webadd" method="post" id="tableForm" name="form1"
            ...
            <div class="panel panel-success" id="main">
                ...
                <div class="panel-heading">
                    <h2 class="panel-title">新建塔吊(使用登记)信息</h2>
                    <a href="<%=basePath %>/web/towerusewebpage.jsp" id="exit">塔吊(使用登记)表查询</a>
                </div>
                ...
                <div class="announce-info">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td class="heading">所关联的塔吊<span style="color:red">  *</span></td>
                            <td colspan="3">
                                <div class="form-group">
