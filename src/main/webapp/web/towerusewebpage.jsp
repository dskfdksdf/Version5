...
<head>
    ...
    <script type="text/javascript" src="${basePath}/web/js/towerusewebpage.js"></script>
</head>
<body>
<div align="center">
...
<div class="panel panel-default">
    ...
    <input type="hidden" id="br" name="br" value="${articleBean.brand}"/>  --%>
        ...
        <div class="panel-heading">
            ...
            <h3 class="panel-title">塔吊(使用情况)信息查询</h3>
            <a href="../toweruse/webadd">新增塔吊(使用登记)信息</a>
        </div>
        ...
        <div class="panel-body">
            <div class="title">
                ...
                <div class="announce-info">
                    <form action="<%=basePath%>/toweruse/webpage" method="post">
