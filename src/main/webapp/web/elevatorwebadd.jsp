...
<html>
<head>
    <title>衡阳市建设工程质量安全监督--施工电梯新建</title>
...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <form action="${basePath}/elevator/webadd" method="post" id="tableForm" name="form1"
            ...
            <div class="panel panel-success" id="main">
                ...
                <div class="panel-heading">
                    <h2 class="panel-title">新建施工电梯信息</h2>
                    <a href="<%=basePath %>/web/elevatorwebpage.jsp" id="exit">施工电梯(产权)表查询</a>
                </div>
