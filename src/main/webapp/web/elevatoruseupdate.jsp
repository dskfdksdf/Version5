    ...
    <script type="text/javascript">
        ...
        function submit1() {
            ...
            if (proname == "" || proaddress == "")
                ...
                alert("修改施工电梯(使用登记)完成");
                var basePath = $('#basePath').val();
                document.form1.action = basePath + '/elevatoruse/webupdate';
        ...
        <form action="#" method="post" id="tableForm" name="form1">
            <div class="panel panel-success" id="main">
                ...
                <div class="panel-heading">
                    ...
                    <a href="<%=basePath%>/web/elevatorusewebpage.jsp" id="exit">查询</a>
                </div>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="form-group">
                                    ...
                                    <input readonly="readonly" class="form-control" id="devicetype" name="devicetype" value="${pb.devicetype}"/>
                                </div>
                            </td>
