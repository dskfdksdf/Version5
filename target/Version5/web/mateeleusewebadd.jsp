...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <form action="${basePath}/mateeleuse/webadd" method="post" id="tableForm" name="form1"
            ...
            <div class="panel panel-success" id="main">
                ...
                <div class="panel-heading">
                    <h2 class="panel-title">新建物料提升机(使用登记)信息</h2>
                    <a href="<%=basePath %>/web/mateeleusewebpage.jsp" id="exit">物料提升机(使用登记)表查询</a>
                </div>
