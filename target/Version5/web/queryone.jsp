...
<script type="text/javascript" src="${basePath}/web/js/queryone.js"></script>
	...
	<div class="panel panel-default">
		...
		<input type="hidden" id="br" name="br" value="${articleBean.brand}"/>  --%>
			...
			<div class="panel-heading">
				...
				<h3 class="panel-title">项目表信息查询</h3>
				<a href="../projectone/webadd">新增项目信息</a>
			</div>
			...
			<div class="panel-body">
				<div class="title">
					...
					<div class="announce-info">
						<form action="<%=basePath%>/projectone/webpage" method="post">
							<table class="table table-bordered">
								<tbody>
									...
									<tr>
										...
										<td class="heading">是否督办</td>
										<td class="heading">
											<div class="form-group">
												<input type="text" class="form-control" id="prourgent"
													name="prourgent" value="${pb.prourgent}" />
											</div>
										</td>
