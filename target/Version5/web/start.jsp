...
<script type="text/javascript" src="${basePath}/web/js/start.js"></script>
	...
	<div class="panel panel-default">
		...
		<input type="hidden" id="br" name="br" value="${articleBean.brand}"/>  --%>
			...
			<div class="panel-heading">
				...
				<h3 class="panel-title">开工表信息查询</h3>
			</div>
			...
			<div class="panel-body">
				<div class="title">
					...
					<div class="announce-info">
						<form action="<%=basePath%>/start/webpage" method="post">
							<table class="table table-bordered">
								<tbody>
									...
									<tr>
										...
										<td class="heading">是否通过</td>
										<td class="heading">
											<div class="form-group">
												<input type="text" class="form-control" id="agree"
													name="agree" value="${pb.agree}" />
											</div>
										</td>
									</tr>
