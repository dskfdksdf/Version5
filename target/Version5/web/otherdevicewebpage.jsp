...
<head>
    ...
    <script type="text/javascript" src="${basePath}/web/js/otherdevicewebpage.js"></script>
</head>
<body>
...
<div align="center">
    ...
    <a href="../otherdevice/webpage">其他设备(产权)</a>
...
<div class="panel panel-default">
    ...
    <input type="hidden" id="br" name="br" value="${articleBean.brand}"/>  --%>
        ...
        <div class="panel-heading">
            ...
            <h3 class="panel-title">其他设备(产权)信息查询</h3>
        </div>
        ...
        <div class="panel-body">
            <div class="title">
                ...
                <div class="announce-info">
                    <form action="<%=basePath%>/otherdevice/webpage" method="post">
                        <table class="table table-bordered">
                            <tbody>
                            <tr>
                                <td class="heading">产权单位名称</td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="propright"
                                               name="propright" value="${pb.propright}" />
                                    </div>
                                </td>
                                <td class="heading">出厂厂家</td>
                                <td>
                                    <div class="form-group">
                            ...
                            <tr>
                                ...
                                <td class="heading">负责人</td>
                                <td class="heading">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="dutyman"
                                               name="dutyman" value="${pb.dutyman}" />
                                    </div>
                                </td>
