...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <form action="${basePath}/mateele/webadd" method="post" id="tableForm" name="form1"
            ...
            <div class="panel panel-success" id="main">
                ...
                <div class="panel-heading">
                    <h2 class="panel-title">新建物料提升机(产权)信息</h2>
                    <a href="<%=basePath %>/web/mateelewebpage.jsp" id="exit">物料提升机(产权)表查询</a>
                </div>
