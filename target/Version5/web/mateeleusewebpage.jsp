...
<head>
    ...
    <script type="text/javascript" src="${basePath}/web/js/mateeleusewebpage.js"></script>
</head>
<body>
<div align="center">
...
<div class="panel panel-default">
    ...
    <input type="hidden" id="br" name="br" value="${articleBean.brand}"/>  --%>
        ...
        <div class="panel-heading">
            ...
            <h3 class="panel-title">物料提升机(使用情况)信息查询</h3>
            <a href="../mateeleuse/webadd">新增物料提升机(使用登记)信息</a>
        </div>
        ...
        <div class="panel-body">
            <div class="title">
                ...
                <div class="announce-info">
                    <form action="<%=basePath%>/mateeleuse/webpage" method="post">
