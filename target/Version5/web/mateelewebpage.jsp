...
<head>
    ...
    <script type="text/javascript" src="${basePath}/web/js/mateelewebpage.js"></script>
...
<div class="panel panel-default">
    ...
    <input type="hidden" id="br" name="br" value="${articleBean.brand}"/>  --%>
        ...
        <div class="panel-heading">
            ...
            <h3 class="panel-title">物料提升机(产权)信息查询</h3>
            <a href="../mateele/webadd">新增物料提升机(产权)信息</a>
        </div>
        ...
        <div class="panel-body">
            <div class="title">
                ...
                <div class="announce-info">
                    <form action="<%=basePath%>/mateele/webpage" method="post">
