...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable({
            ...
            url: basePath+'/elevatoruse/webquery',     //请求后台的URL（*）
...
{
    var basePath = $("#basePath").val();
    window.location.href=basePath+"/elevatoruse/webtoupdate?id="+id;
}

function history(proRproid) {
    var basePath = $("#basePath").val();
    var url = basePath + "/elevatoruseRecord/webpage?Rid=" + proRproid;
    window.location.href = url;
}