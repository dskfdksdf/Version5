...
<script type="text/javascript" src="${basePath}/web/js/reformquery.js"></script>

</head>
<body>
	<div align="center">
		<a href="../projectone/webpage">项目表</a> <a href="../reform/webpage">整改表</a>
		<a href="../enforce/webquery">执法表</a> <a href="../start/webpage">开工表</a>
			...
			<div class="panel-body">
				<div class="title">
					...
					<div class="announce-info">
						<form action="<%=basePath%>/reform/webpage" method="post">
							<table class="table table-bordered">
								<tbody>
									<tr>
										<td class="heading">整改id</td>
										<td>
											<div class="form-group">
												<input type="text" class="form-control" id="reid"
													name="reid" value="${pb.reid}" />
											</div>
										</td>
										<td class="heading">整改单编号</td>
										<td>
											<div class="form-group">
												<input type="text" class="form-control" id="rezhenggaiid"
													name="rezhenggaiid" value="${pb.rezhenggaiid}" />
											</div>
										</td>
									</tr>

									<tr>
											<td class="heading">是否督促</td>
										<td class="heading">
											<div class="form-group">
												<input type="text" class="form-control" id="reurgent"
													name="reurgent" value="${pb.reurgent}" />
											</div>
										</td>
										<td class="heading">违法项目名</td>
										<td class="heading">
											<div class="form-group">
												<input type="text" class="form-control" id="reillproStr"
													name="reillproStr" value="${pb.reillproStr}" />
											</div>
										</td>
									</tr>
