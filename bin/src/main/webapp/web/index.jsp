...
<span style="display: none;" id="multiadd">${multiadd}</span>
	<div class="panel panel-default">
		<div class="panel-body">
		 ...
		 <form  action="${basePath}/project/webadd" method="post" id="tableForm" name="form1" enctype="multipart/form-data">
                                ...
                                <tr>
                                       ...
                                       <input type="file" name="mulfile" id="mulfile" />
                                         ...
                                         <div class="form-group" >
                                           <button type="button" onclick="multiupload()"  class="btn btn-default" ><i class="fa fa-lock fa-large" ></i>批量新增</button>
                                             </div>
                                         </td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                   ...
                                   <tr>
                                         <td colspan="4" class="heading">
                                                <button type="submit" class="btn btn-default" ><i class="fa fa-lock fa-large" ></i>新增</button>
